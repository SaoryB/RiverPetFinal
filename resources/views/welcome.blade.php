    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white py-3 shadow-sm">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item"><a class="nav-link" href="{{ url('welcome') }}"><strong class="h6 mb-0 font-weight-bold text-uppercase">Inicio</strong></a></li>
              <li class="nav-item"><a class="nav-link" href="{{ url('publicperfil') }}">Quem Somos</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ url('publicplano') }}">Planos</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ route('login') }}">Área do Admin</a></li>
          </ul>
      </div>
  </div>
</nav>
...
<div class="text-left">
<br/>
<a href="{{ url('agenda/create') }}" button type="button" class="btn btn-success btn-lg">
